...
const handleLibrary = async (bookId: number) => {
  ...
  const handleClose = () => {
    ...
    const handleSubmitClick = () => {
        ...
        if ((tempBook.author === "" || tempBook.title === "" || tempBook.category === "" )&& Number.isInteger(parseFloat(tempBook.time))) {
      ...
      >
        <Fade in={open}>
          ...
          onChange={(event) => setCategory(event.target.value)}
           ...
           >
          <MenuItem value={"Enterprenuership"}>Enterprenuership</MenuItem>
          ...
          <MenuItem value={"Nature and the Environmet"}>Nature and the Environmet</MenuItem>
